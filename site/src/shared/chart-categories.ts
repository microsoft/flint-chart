...
const spec = assembleVegaLite(input);`,
    charts: [
      ...
      createChart('vegalite', 'calendar-heatmap', 'Calendar Heatmap', 'Calendar Heatmap', calendarIcon),
...
const option = assembleECharts(input);`,
    charts: [
      ...
      createChart('echarts', 'echarts-pyramid', 'Pyramid Chart', 'Pyramid Chart', pyramidIcon),
...
const figure = assemblePlotly(input);`,
    charts: [
      ...
      createChart('plotly', 'plotly-density-contour', 'Density Contour', 'Density Contour', densityIcon),
